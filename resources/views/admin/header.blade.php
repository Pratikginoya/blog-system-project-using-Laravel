        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/admin/view-heading" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Manage Website Heading</p>
                </a>
              </li>
            </ul>
          </li>
...
<!-- Blog -->
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/admin/manage-blog" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Blog for Approval</p>
                </a>
              </li>
            </ul>
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/admin/view-all-blog" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>View Live Blog</p>
                </a>
              </li>
